...
# sphinx-quickstart on Sun Oct 15 00:53:38 2017.
#
...
latex_documents = [
    (master_doc, 'Movidius.tex', 'Movidius Documentation',
     'Movidius', 'manual'),
]
...
man_pages = [
    (master_doc, 'Movidius', 'Movidius Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Movidius', 'Movidius Documentation',
     author, 'Movidius', 'One line description of project.',
     'Miscellaneous'),
]
